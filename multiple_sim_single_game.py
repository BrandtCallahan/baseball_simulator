...
def truegamesim(team1,team2):
    ...
    if sum(rg1)>sum(rg2): #team 1 win
        tw = [1,sum(rg1),sum(BBtotal1),sum(B1total1),sum(B2total1),sum(B3total1),sum(HRtotal1),sum(LOBtotal1),sum(Ktotal1),sum(GOtotal1),sum(FOtotal1),sum(PCtotal1),sum(rg2),sum(BBtotal2),sum(B1total2),sum(B2total2),sum(B3total2),sum(HRtotal2),sum(LOBtotal2),sum(Ktotal2),sum(GOtotal2),sum(FOtotal2),sum(PCtotal2)]
    else: #team 2 win
        tw = [2,sum(rg1),sum(BBtotal1),sum(B1total1),sum(B2total1),sum(B3total1),sum(HRtotal1),sum(LOBtotal1),sum(Ktotal1),sum(GOtotal1),sum(FOtotal1),sum(PCtotal1),sum(rg2),sum(BBtotal2),sum(B1total2),sum(B2total2),sum(B3total2),sum(HRtotal2),sum(LOBtotal2),sum(Ktotal2),sum(GOtotal2),sum(FOtotal2),sum(PCtotal2)]
