...
def get_game_matchups(url=None, game_date=None):
    ...
    for header_node in header_nodes:
        try:
            ...
            try:
                postponed = game_node.find("div", {"class": "heading__desc"}).text
            except AttributeError:
                postponed = ""

            if postponed == "This game has been postponed.":
                matchup = "POSTPONED"
                pass
            else:
